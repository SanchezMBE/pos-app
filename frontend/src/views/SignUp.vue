        ...
        <div class="d-flex flex-column justify-content-center h-100 p-5">
          ...
          <div class="features mt-4">
            <div class="d-flex align-items-center mb-3">
              ...
              <span>Gestión eficiente de inventario y ventas</span>
            </div>
            <div class="d-flex align-items-center mb-3">
              <i class="bi bi-check-circle-fill me-3 fs-4"></i>
              <span
                >Corte de caja automatizado con conciliación financiera</span
              >
            </div>
            <div class="d-flex align-items-center">
              <i class="bi bi-check-circle-fill me-3 fs-4"></i>
              <span>Sistema de roles para control de acceso seguro</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 bg-white">
        ...
        >
          <div class="text-center mb-4">
            ...
            <p class="text-muted">
              Regístrate para empezar a optimizar tu negocio
            </p>
          </div>
