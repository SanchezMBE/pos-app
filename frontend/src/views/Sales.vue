...
const subtotal = computed(() =>
  productos.value.reduce((sum, p) => sum + p.precio * p.cantidad, 0)
);

const descuento = computed(() =>
  productos.value.reduce((sum, p) => sum + p.descuento, 0)
);
    ...
    <div class="card shadow-lg border-0">
      <div class="card-body">
        ...
        <div class="mb-4">
          ...
          <input v-model="cliente" type="text" class="form-control form-control-lg" placeholder="Nombre del cliente" />
        </div>
        ...
        <div class="row g-3 align-items-end">
          ...
          <div class="col-md-8">
            ...
            <div class="input-group">
              <input v-model="producto" type="text" class="form-control form-control-lg" placeholder="Buscar producto" />
